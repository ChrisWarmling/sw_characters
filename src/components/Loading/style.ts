...
.ls-particles {
    ...
    width: 1px;
    height: 5px;
    background-color: rgb(18, 250, 255, 0);
...
.lightsaber.ls-green:before {
    -webkit-animation: showlightgreen 1s ease-in-out infinite .5s; animation: showlightgreen 1s ease-in-out infinite .5s;
}

.lightsaber.ls-red:before {
    -webkit-animation: showlightred 1s ease-in-out infinite .5s; animation: showlightred 1s ease-in-out infinite .5s;
}


.lightsaber.ls-left {
    -webkit-animation: fightleft 1s ease-in-out infinite .5s; animation: fightleft 1s ease-in-out infinite .5s;
}

.lightsaber.ls-right {
    -webkit-animation: fightright 1s ease-in-out infinite .5s; animation: fightright 1s ease-in-out infinite .5s;
}

.ls-particles.ls-part-1 {
    -webkit-animation: particles1 1s ease-out infinite .5s; animation: particles1 1s ease-out infinite .5s;
}

.ls-particles.ls-part-2 {
    -webkit-animation: particles2 1s ease-out infinite .5s; animation: particles2 1s ease-out infinite .5s;
}

.ls-particles.ls-part-3 {
    -webkit-animation: particles3 1s ease-out infinite .5s; animation: particles3 1s ease-out infinite .5s;
}

.ls-particles.ls-part-4 {
    -webkit-animation: particles4 1s ease-out infinite .5s; animation: particles4 1s ease-out infinite .5s;
}
...
@-webkit-keyframes showlightgreen {
    0% {
        max-height: 0;
        box-shadow: 0 0 0 0 #12FAFF;
    }
  
    5% {
        box-shadow: 0 0 4px 2px #12FAFF;
    }
...
@-webkit-keyframes particles1 {
    0% {
        background-color: rgba(18, 250, 255,0);
    ...
    64% {
        background-color: rgba(18, 250, 255,1);
        -webkit-transform: rotateZ(35deg) translateY(0px);
        transform: rotateZ(35deg) translateY(0px);
    }
